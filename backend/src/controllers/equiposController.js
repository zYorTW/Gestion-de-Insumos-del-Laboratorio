...
exports.crearEquipo = async (req, res) => {
  try {
    ...
    await pool.execute(sql, [
      ...
      clasificacion ?? null,
      manual_usuario ?? null,
      puesta_en_servicio ?? null,
      fecha_adquisicion ?? null,
      requerimientos_equipo ?? null,
      elementos_electricos ?? null,
      voltaje ?? null,
      elementos_mecanicos ?? null,
      frecuencia ?? null,
      campo_medicion ?? null,
      exactitud ?? null,
      sujeto_verificar ?? null,
      sujeto_calibracion ?? null,
      resolucion_division ?? null,
      sujeto_calificacion ?? null,
      accesorios ?? null
    ]);
